...
import org.samo_lego.dungeons_packer.block.corner.TileCornerBlock;
...
public class ConverterBlocks {
	...
	private static ResourceKey<Block> keyOfBlock(String name) {
		return ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(DungeonsPacker.MOD_ID, name));
	}


	public static ResourceKey<Item> keyOfItem(String name) {
		return ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DungeonsPacker.MOD_ID, name));
	}
