...
import org.samo_lego.dungeons_exporter.block.corner.TileCornerBlockEntity;
import org.samo_lego.dungeons_exporter.lovika.ObjectGroup;
...
public class TileListener {
    ...
    public void onCornerRemoved(TileCornerBlockEntity removed) {
        if (this.cornerEntity == removed) {
            ...
            if (matching.isEmpty()) {
                DungeonsExporter.LOGGER.warn("Corner removed without matching corner set.");
                return;
            }
